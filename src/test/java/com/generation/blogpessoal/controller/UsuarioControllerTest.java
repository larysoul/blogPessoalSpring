...
public class UsuarioControllerTest {
	...
	public void deveListarUsuarioPorId() {
		...
		Optional<Usuario> usuarioBusca = usuarioService.cadastrarUsuario(
				new Usuario(0L, "Scar", "scarrein@gmail.com", "scar123", "https://imgur.com/AvF8Xzj"));
	...
	public void deveFazerLogin() {
		...
		usuarioService.cadastrarUsuario(
				new Usuario(0L, "Mufasa", "mufasapai@gmail.com", "mufasa123", "https://imgur.com/V9mAGjZ"));

		HttpEntity<UsuarioLogin> corpoRequisicao = new HttpEntity<UsuarioLogin>(
				new UsuarioLogin(0L, "", "mufasapai@gmail.com", "mufasa123", ""));
